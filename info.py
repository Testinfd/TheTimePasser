...
PICS = (environ.get('PICS', 'https://placeholder.com/bot-start-image.jpg')).split()
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://placeholder.com/payment-qr.jpg') # payment code picture url.
